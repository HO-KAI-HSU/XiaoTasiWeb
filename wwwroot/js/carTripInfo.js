...
$(function () {
    ...
    $(document).on("click", ".trip_more_btn", function () {
        ...
        var travelStepCode = $inputTab.val();
        console.log(travelStepCode);
        console.log("/TripReservation/TripReservation?travelStepCode=" + travelStepCode + "&travelType=4");
        top.location.href = "/TripReservation/TripReservation?travelStepCode=" + travelStepCode + "&travelType=4";
    });
});
